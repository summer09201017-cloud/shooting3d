// gen-voice.mjs —— 把播報詞庫用 edge-tts(微軟雲哲神經語音=男聲轉播感,免費)預烤成 mp3。
...
// 新增播報詞:加進 PHRASES 再重跑(累加式,已有的檔跳過)。
...
const VOICE = "zh-TW-YunJheNeural"; // 雲哲(男聲,轉播感);柔和女聲可換 zh-TW-HsiaoChenNeural
